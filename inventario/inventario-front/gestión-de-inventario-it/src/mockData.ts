...
export const INITIAL_AGENT_COMPUTERS: AgentComputer[] = [
  ...
  },
  {
    ...
    estado_it: 'Asignada',
    responsable_inventario: 'Agustina (RRHH)',
    os_detalles: {
      edicion: 'Windows 10 Home',
      version_mostrada: '22H2',
      build: '19045',
      ubr: '6456',
      build_lab: '19041.1.amd64fre.vb_release.191206-1406'
    },
    historial_estados: [
      {
        fecha: '3 de junio de 2026, 10:00 AM',
        autor: 'Daniel Ortega (IT Admin)',
        estado_anterior: 'En Almacén',
        estado_nuevo: 'Asignada',
        motivo: 'Entrega inicial del equipo a Agustina de Recursos Humanos.'
      }
    ],
