...
import { esMouse } from '../utils/perifericos';
...
function PerifericosMouseList() {
  ...
  return (
    <div className="page">
      <h1>Mouse</h1>
      <p className="muted">Dispositivos apuntadores USB detectados por el agente (heurística por clase/nombre).</p>
      <div className="card">
