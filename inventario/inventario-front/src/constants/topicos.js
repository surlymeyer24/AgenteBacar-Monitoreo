export const TOPICOS = [
  ...
  },
  {
    ...
    path: '/perifericos',
    children: [
      { id: 'perifericos-dashboard', label: 'Dashboard', path: '/perifericos/dashboard', iconKey: 'LayoutDashboard' },
      ...
      { id: 'televisores', label: 'Televisores', path: '/perifericos/televisores', iconKey: 'Tv' },
      { id: 'celulares', label: 'Celulares', path: '/perifericos/celulares', iconKey: 'Smartphone' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'access-points', label: 'Access Points', path: '/access-points', iconKey: 'Wifi' },
